...
/** The Deck uses the deck API, allowing to draw one card at a time. */
...
function Deck() {
    ...
    /** autoDraw draws card every second if autoDraw is true*/
    ...
    return (
        <div className="Deck">
            {deck ? (
                <button className="Deck-gimme" onClick={toggleAutoDraw}>{autoDraw ? "STOP" : "KEEP"} DRAWING FOR ME.
                </button>
            ) : null}
